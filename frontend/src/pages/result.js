      ...
      <table className="table-auto w-full border-collapse border border-gray-300">
        <thead>
          <tr className="bg-gray-100">
            <th className="border border-gray-300 px-4 py-2">Result Name</th>
...
const diagnosis = () => {
  ...
  return (
    <div className="container mx-auto p-8">
      ...
      <button onClick={() => Router.push("/output")} className="btn btn-primary w-100 mt-4">Go to Output</button>
      <button onClick={() => Router.push("/")} className="btn btn-primary w-100 mt-4">Go to Home</button>
    </div>
  );
};
